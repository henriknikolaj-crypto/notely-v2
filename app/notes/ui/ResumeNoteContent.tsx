...
import { noteContentFallbackMessage, renderableNoteContent } from "@/lib/notes/contentSafety";
...
export default function ResumeNoteContent({ content }: Props) {
  const safeContent = renderableNoteContent(content);
